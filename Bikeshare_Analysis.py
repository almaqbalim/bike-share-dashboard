...
def load_data():
    df = pd.read_csv(
        r"C:\Users\engal\OneDrive\Desktop\CaseStudy\BikeShire\Dashboard\Data\dataset_after_clean.csv")
...
st.markdown(
    ...
    "[🔗 View Project on GitHub](https://github.com/your-username/bike-share-analysis)"
)
